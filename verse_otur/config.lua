...
Config.Lang = {
    ...
    Notification = {
        ...
        NoAvailable = "Hiçbir koltuk mevcut değil!",
        NoFound = "Hiçbir koltuk bulunamadı!",
        NoBedFound = "Üzerine uzanacak hiçbir şey bulunamadı!",
        TooTilted = "Bu koltuk çok eğik!",
        CannotReachSeat = "Bu koltuğa ulaşamazsınız!",
        CannotSitInSeat = "Bu koltuğa oturamazsınız!",
        CannotReachBed = "Bu yatağa/banka ulaşamazsınız!",
    ...
    -- Chat Suggestions
    ChatSuggestions = {
        Sit = "En yakın koltuğa oturun",
        Lay  = "En yakın yatağa/banka uzan"
    },

    -- Key Mapping
    KeyMapping = {
        -- %s is automatically replaced with the key they need to press.
        SitDown = "Oturmak için %s'ye basın",
        LayDown = "Yatmak için %s'ye basın",
        GetUp = "Kalkmak için %s'ye basın"
    },

    -- Description in Settings>Key Bindings>Fivem
    KeyBindingDesc = {
        Keyboard = {
            SitDown = "Otur - Koltuğa Otur",
            LayDown = "Otur - Yatağa / Bank'a Uzan",
            GetUp = "Otur - Koltuktan/Yataktan Kalk"
        },
        PadAnalog = {
            SitDown = "Otur - Koltuğa Otur - Kontrolör",
            LayDown = "Otur - Yatağa/ Bank'a Uzan - Kontrolör",
            GetUp = "Otur - Koltuktan/Yataktan Kalk - Kontrolör"
        }
    }
}
